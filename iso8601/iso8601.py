...
# Same thing, except we do not treat the : separators in time as optional and
# are a bit more lenient about the lengths of the hour, minute, etc. section
ISO8601_REGEX2 = re.compile(
    r"""
    (?P<year>[0-9]{4})
    (
        (
...
def parse_date(
    ...
    try:
        ...
        try:
            m = ISO8601_REGEX2.match(datestring)
        except Exception as e:
            raise ParseError(e)
